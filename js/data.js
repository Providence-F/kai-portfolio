  ...
  projects: [
    {
      ...
      nameEn: "Research OS",
      description: "一套自己正在迭代的研究工作系统。把信息搜集、假设验证到结论输出的过程，整理成可重复、可回查的流程：关键结论必须标注来源和证据链，反方意见与修改记录也留档，方便复盘和纠错。已在南芥智能的 AI Agent 商业研究中实际使用，累计输出 30 余份带证据链的调研报告。它不是为了自动产出答案，而是帮助我在信息过载时，仍能用较低的认知负担做出有依据的判断。",
      descriptionEn: "A personal research workflow system I keep iterating. It turns information gathering, hypothesis validation, and conclusion output into a repeatable, auditable process: key conclusions are tagged with sources and evidence links, while counter-arguments and revisions are also documented for later review. Used in real AI-agent business research at Nanjie Intelligence, producing 30+ evidence-linked research reports. It is not designed to auto-generate answers, but to help me make evidence-based decisions without being overwhelmed by information.",
      year: "2026",
      category: "AI 产品",
