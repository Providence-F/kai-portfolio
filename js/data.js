...
window.PianoApp.data = {
  projects: [
    {
      ...
      nameEn: "Research OS",
      description: "这是我为自己打磨的一套研究 workflow。做调研时，信息总是又多又散，我把它整理成「搜集—验证—下结论」三步可回查的流程：每条关键结论都附上来源和证据链，改动和不同意见也一并留档，方便回头复盘。在南芥智能的 AI Agent 商业研究里实际用了这套方法，累计输出 30 多份带证据链的报告。它不是帮我自动生成答案，而是让我在信息过载时，还能用较低的认知负担做出有依据的判断。",
      descriptionEn: "A research workflow I built for myself. When investigating, information tends to be scattered and overwhelming, so I structured the process into three auditable steps—gather, validate, conclude. Every key claim is backed by sources and evidence links, and changes or counter-opinions are kept on record for later review. I used this method in real AI-agent business research at Nanjie Intelligence, producing 30+ evidence-linked reports. It doesn't auto-generate answers for me; it helps me make evidence-based decisions without burning out on information overload.",
      year: "2026",
      category: "AI 产品",
      categoryEn: "AI Product",
      image: "assets/images/research-os.webp",
    ...
    },
    {
      ...
      category: "AI 产品",
      categoryEn: "AI Product",
      image: "assets/images/knowledge-tarot.webp",
    ...
    },
    {
      ...
      image: "assets/images/firefly/07526b43d77772878c7d9334e13ae84b.webp",
      images: [
        "assets/images/firefly/07526b43d77772878c7d9334e13ae84b.webp",
        "assets/images/firefly/1c05264f3149f3bc6c0584a728025bd8.webp",
        "assets/images/firefly/592c397dac318fa6b62eedf4bbf8e850.webp",
        "assets/images/firefly/8117715f65bb89eea1fd9346f7108e20.webp",
        "assets/images/firefly/8a28b2bbfd27aa5272b300297e8b56ed.webp",
        "assets/images/firefly/8c3799d73a2aabaeefb213c0b8e64976.webp",
        "assets/images/firefly/adccfa4676dc26ea770cc85976600eac.webp",
        "assets/images/firefly/b6b2865b569d7365851ce6f53d98dac4.webp",
        "assets/images/firefly/de3b2075aad3ad326179f0b8b21dda44.webp",
      ],
      tech: ["项目管理", "科普策展", "运营传播"],
  ...
  about: {
    ...
    avatar: "assets/images/portrait-new.webp",
    avatarAlt: "房宇航的自画像",
    ...
    socialLinks: [
      { name: "电话", nameEn: "Phone", type: "copy", value: "18951391402", icon: "phone" },
      { name: "邮箱", nameEn: "Email", type: "copy", value: "3166831387@qq.com", icon: "email" },
    ],
  },
